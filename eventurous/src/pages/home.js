...
export class IndexPage extends Component {
	...
	onSelect = async data => {
		...
		let response = await axios.get(
			"https://eventurousa2z.herokuapp.com/get-coords",
			httpOptions
		);
		if (response.data.results && response.data.results.length > 0) {
			...
			response = await axios.get(
				"https://eventurousa2z.herokuapp.com/get-distance",
				httpOptions
			);
			...
			response = await axios.get(
				"https://eventurousa2z.herokuapp.com/get-events",
				httpOptions
			);
			...
			response = await axios.get(
				"https://eventurousa2z.herokuapp.com/get-weather",
				httpOptions
			);
