...
export class CurrencyExchangePage extends Component {
  ...
  getSymbols = async () => {
    const response = await axios.get('https://eventurousa2z.herokuapp.com/get-currency-symbols');
  ...
  getRates = async () => {
    const response = await axios.get('https://eventurousa2z.herokuapp.com/get-latest-rates');
