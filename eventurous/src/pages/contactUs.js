...
export class ContactUsPage extends Component {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
  getPlaces = () => {
    Axios.get(`https://eventurousa2z.herokuapp.com/get-places?temperature=${this.state.current_temperature}&status=${this.state.current_description}&lat=${this.state.latitude}&lon=${this.state.longitude}`)
      .then(res => {
